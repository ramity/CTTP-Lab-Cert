...
var KEY_MAP = {
  ...
  ,'BACKSPACE': 8
  ,'DELETE': 46
  //START NEW KEY SUPPORT @RAMITY
  ,'CTRL': 17
  ,'TAB': 9
  ,'END': 35
  //,'HELP': mixed codes,  not included
  ,'HOME': 36
  ,'INSERT': 45
  ,'PAGEDOWN': 34
  ,'PAGEUP': 33
  //,'PRINTSCREEN':mixed codes, not included
  //,'SCROLLLOCK':mixed codes, not included
  //,'PAUSE':mixed codes, not included
